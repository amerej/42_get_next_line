...
/*   Updated: 2017/01/16 11:39:36 by aditsch          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			main(int argc, char *argv[])
{
	...
	// gnl_multi_fd(fd_4, &line);
	// printf("line = %s\n", line);
	gnl_multi_fd(fd_1, &line);
	printf("line = %s\n", line);
	gnl_multi_fd(fd_1, &line);
	printf("line = %s\n", line);
	gnl_multi_fd(-5, &line);
	printf("line = %s\n", line);
	// gnl_multi_fd(fd_2, &line);
	// printf("line = %s\n", line);
	// gnl_multi_fd(fd_1, &line);
	// printf("line = %s\n", line);
	// gnl_multi_fd(fd_3, &line);
	// printf("line = %s\n", line);
	// gnl_multi_fd(fd_4, &line);
	// printf("line = %s\n", line);
	// gnl_multi_fd(fd_5, &line); // Test with not existing file
	// printf("line = %s\n", line);
	// gnl_multi_fd(fd_6, &line);
	// printf("line = %s\n", line);
	// gnl_multi_fd(fd_1, &line);
	// printf("line = %s\n", line);
	return (FALSE);
